...
const (
	ReminderService_ScheduleReminder_FullMethodName = "/reminders.ReminderService/ScheduleReminder"
)
...
func (c *reminderServiceClient) ScheduleReminder(ctx context.Context, in *ScheduleReminderRequest, opts ...grpc.CallOption) (*ScheduleReminderResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReminderService_ScheduleReminder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReminderService_ScheduleReminder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReminderService_ScheduleReminder_FullMethodName,
	}
...
var ReminderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "reminders.ReminderService",
	...
	Metadata: "reminder-service/proto/reminder.proto",
}
